...
This project is indexed by GitNexus as **emdash** (31229 symbols, 54024 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/emdash/context` | Codebase overview, check index freshness |
| `gitnexus://repo/emdash/clusters` | All functional areas |
| `gitnexus://repo/emdash/processes` | All execution flows |
| `gitnexus://repo/emdash/process/{name}` | Step-by-step execution trace |
